...
import { Close, Delete, Eye } from "components/Icons";
import {
  ModalCloseButton,
  ModalContent,
  StyledIconButton,
...
const DisplayImage: FC<IDisplayImage> = ({
  width,
  height,
  size,
  value,
  ...
  return (
    <StyledImageBlock width={width} height={height} size={size}>
      {value ? (
        <StyledImage
      ...
      <Modal title="" open={open} onCancel={handleClose} onOk={handleClose}>
